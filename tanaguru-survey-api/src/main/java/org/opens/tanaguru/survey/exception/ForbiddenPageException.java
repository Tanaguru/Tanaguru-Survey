...
public class ForbiddenPageException extends RuntimeException{
    ...
    private static final long serialVersionUID = -5272026528120353376L;
    private static final String FORBIDDEN_USER_EXCEPTION_MSG_KEY = "forbidden-page-exception-msg-key";
